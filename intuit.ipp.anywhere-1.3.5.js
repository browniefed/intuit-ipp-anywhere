...
intuit.ipp.anywhere.controller = {
    ...
    getOAuthUri: function () {
        ...
        /*if (intuit.ipp.anywhere.datasources.desktop && intuit.ipp.anywhere.desktopOptions.enableDesktop) {
            datasources.push("desktop");
        }*/
        if(intuit.ipp.anywhere.datasources.desktop)
            {
                if(intuit.ipp.anywhere.desktopOptions.enableDesktop)
                    datasources.push("desktop");
                else
                    datasources.push("noqbd");
            }
        var paymentOptions = [];
